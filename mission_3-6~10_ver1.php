...
<!-質問スレッド表示->
	<?php if( isset($_SESSION['login']) ): ?>
			...
			<p>物理の交流回路における消費電力についてです。</p>
			
			<p>ある抵抗器Rにかかる電位差の実効値をVe、最大値をV₀とします。<br>
			電流の実効値をIe、最大値をI₀とします。</p>
			...
			<p>そこで質問なのですが、<br>
			消費電力を求める際に、実効値を使うか最大値を使うか迷います。<br>
			試してみた感じ、結局どのルートで計算しても同じ結果に収束するようです。<br>
			つまり実効値と最大値をどこで代入しようが関係ないって解釈でよろしかったでしょうか？</p>
			</div>
